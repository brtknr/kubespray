...
ansible-playbook -i inventory/kata/inventory.ini -i ~/p3-appliances/ansible/inventory-kata --vault-password-file=~/p3-appliances/vault-password --become cluster.yml
```
